...
import SeasonalPlanner from "./SeasonalPlanner";
...
const SAVINGS_IDEAS = {
  under50: [
    ...
    },
    {
      label: "Sawada Coffee",
      note: "$6–$13",
      map: "https://maps.google.com/?q=Sawada+Coffee+Chicago",
      menu: "https://www.sawadacoffee.com/",
      items: ["Military latte", "Matcha latte", "Espresso tonic"],
      category: "cafes" as const,
    },
    {
      label: "Metric Coffee",
      note: "$5–$11",
      map: "https://maps.google.com/?q=Metric+Coffee+Chicago+Loop",
      menu: "https://metriccoffee.com/",
      items: ["Single origin pour‑over", "Cortado", "Cold brew"],
      category: "cafes" as const,
    },
    {
      label: "Argo Tea (Wacker Dr)",
      note: "$5–$10",
      map: "https://maps.google.com/?q=Argo+Tea+Chicago+Loop",
      menu: "https://argotea.com/",
      items: ["Mango green tea", "Chai latte", "Sparkling tea"],
      category: "cafes" as const,
    },
    {
      label: "Peet's Coffee (Loop)",
      note: "$5–$11",
      map: "https://maps.google.com/?q=Peet%27s+Coffee+Chicago+Loop",
      menu: "https://www.peets.com/pages/store-locator",
      items: ["Dark roast drip", "Caramel macchiato", "Almond croissant"],
      category: "cafes" as const,
    },
    {
      label: "Caribou Coffee (LaSalle St)",
      note: "$5–$10",
      map: "https://maps.google.com/?q=Caribou+Coffee+LaSalle+Chicago",
      menu: "https://www.cariboucoffee.com/",
      items: ["Northern Lite latte", "Crafted Press", "Blueberry muffin"],
      category: "cafes" as const,
    },
    {
    ...
    {
      label: "Protein Bar & Kitchen",
      note: "$10–$16",
      map: "https://maps.google.com/?q=Protein+Bar+Kitchen+Chicago+Loop",
      menu: "https://www.theproteinbar.com/",
      items: ["Grain bowl", "Quinoa burrito", "Recovery smoothie"],
      category: "restaurants" as const,
    },
    {
      label: "Wow Bao (fast Asian buns)",
      note: "$8–$14",
      map: "https://maps.google.com/?q=Wow+Bao+Chicago+Loop",
      menu: "https://www.wowbao.com/",
      items: ["BBQ pork bao", "Edamame dumplings", "Chicken fried rice"],
      category: "restaurants" as const,
    },
    {
      label: "Goddess & the Grocer",
      note: "$12–$20",
      map: "https://maps.google.com/?q=Goddess+and+the+Grocer+Chicago+Loop",
      menu: "https://www.goddessandthegrocer.com/",
      items: ["Turkey avocado sandwich", "Soup of the day", "Grain salad"],
      category: "restaurants" as const,
    },
    {
      label: "Chipotle (Wacker Dr)",
      note: "$10–$15",
      map: "https://maps.google.com/?q=Chipotle+Wacker+Drive+Chicago",
      menu: "https://www.chipotle.com/",
      items: ["Burrito bowl", "Chicken tacos", "Sofritas bowl"],
      category: "restaurants" as const,
    },
    {
      label: "Sweetgreen (Loop)",
      note: "$12–$18",
      map: "https://maps.google.com/?q=Sweetgreen+Chicago+Loop",
      menu: "https://www.sweetgreen.com/menu",
      items: ["Harvest bowl", "Kale caesar", "Guacamole greens"],
      category: "restaurants" as const,
    },
  ],
  under100: [
    ...
    {
      label: "Avec (small plates)",
      note: "$30–$65",
      map: "https://maps.google.com/?q=Avec+Chicago",
      menu: "https://www.avecrestaurant.com/",
      items: ["Chorizo-stuffed dates", "Wood-roasted fish", "Charcuterie board"],
      category: "restaurants" as const,
    },
    {
      label: "Osteria Langhe",
      note: "$30–$65",
      map: "https://maps.google.com/?q=Osteria+Langhe+Chicago",
      menu: "https://www.osterialanghe.com/",
      items: ["Tajarin pasta", "Beef brasato", "Barolo wine"],
      category: "restaurants" as const,
    },
    {
      label: "Little Goat Diner",
      note: "$20–$50",
      map: "https://maps.google.com/?q=Little+Goat+Diner+Chicago",
      menu: "https://www.littlegoatchicago.com/",
      items: ["Goat belly biscuit", "This Little Piggy burger", "Cereal milk shake"],
      category: "restaurants" as const,
    },
    {
      label: "Café Iberico (tapas)",
      note: "$25–$55",
      map: "https://maps.google.com/?q=Cafe+Iberico+Chicago",
      menu: "https://www.cafeiberico.com/",
      items: ["Patatas bravas", "Gambas al ajillo", "Sangria pitcher"],
      category: "restaurants" as const,
    },
    {
    ...
    {
      label: "RPM Italian (River North)",
      note: "$45–$85",
      map: "https://maps.google.com/?q=RPM+Italian+Chicago",
      menu: "https://www.rpmrestaurants.com/rpm-italian/",
      items: ["Bucatini all’Amatriciana", "Branzino al forno", "Tiramisu"],
      category: "restaurants" as const,
    },
    {
      label: "Fogo de Chão — Loop",
      note: "$60–$90",
      map: "https://maps.google.com/?q=Fogo+de+Chao+Chicago+Loop",
      menu: "https://fogodechao.com/location/chicago/",
      items: ["Full churrasco experience", "Market table salads", "Caipirinha"],
      category: "restaurants" as const,
    },
    {
